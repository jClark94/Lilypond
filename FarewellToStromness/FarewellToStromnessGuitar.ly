...
lower = \relative c, {
  ...
  \scaleDurations #'(2 . 3) {
    ...
    <a'\4 e\5>8\harmonic^\markup { \italic { \fontsize #-2 { "harm. 7" }}}
...
middle = \relative c {
  ...
  d'4\3 <a' cis> s4 <cis,\3 a'> d\3 a'\2 s <a cis,\3> d,4\3 a'
...
upper = \relative c' {
  ...
  \scaleDurations #'(2 . 3) {
    ...
    \repeat volta 2 {
      ...
      << {fis16\2 g~\2 g4 } \\ {d'4*3/2 } >> s4. << {b,16 d~\3 d4 } \\ { b'4*3/2 } >>  s4. << {fis16\2 g\2~ g4 } \\ { d'4*3/2 } >> e16 d8. cis8 <cis b,>16 <b\2 d,\4>\harmonic^\markup{\italic\small{harm. 12} }~ <b d,\3>4\harmonic  s4 r8
      << {fis16\2 g~\2 g4 } \\ {d'4*3/2 } >> \acciaccatura d8 cis4 s8
      cis16 
    b8.\harmonic\2^\markup { \italic { \fontsize #-2 { "harm. 12" }}}
    g8\3^\markup { \italic { \fontsize #-2 { "harm. 12" }}}    
    a4\2 a,\harmonic8\4^\markup { \italic { \fontsize #-2 { "harm. 7" }}}  
  ...
  <<
    \new StaffGroup = "tab with traditional" <<
      ...
      <<
        ...
        \set harmonicDots = ##t
        \context Voice = "upper" { \partcombine \upper \middle }
